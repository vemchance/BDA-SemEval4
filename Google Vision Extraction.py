...
for dirpath, dirnames, filenames in os.walk('X:\\PhD\\SemEval Task4\\Data\\subtask2a_images'):
...
for dirpath, dirnames, filenames in os.walk('X:\PhD\SemEval Task4\Data\subtask2b_images'):
    for filename in [f for f in filenames]:
