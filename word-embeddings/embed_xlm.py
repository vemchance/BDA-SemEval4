...
tokenizer = AutoTokenizer.from_pretrained('xlm-roberta-large', device=device)
model = XLMRobertaModel.from_pretrained('xlm-roberta-large', return_dict=True).to(device)
